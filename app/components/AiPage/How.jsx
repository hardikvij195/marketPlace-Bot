        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            <div className="relative w-full flex items-center justify-center">
              <div className="absolute top-1/2 left-0 w-full h-0.5 bg-gradient-to-r from-[#5B86E5] to-[#3C3B92] transform -translate-y-1/2 z-0" />
              <div className="bg-gradient-to-r from-[#5B86E5] to-[#3C3B92] rounded-full w-20 h-20 flex items-center justify-center z-10">
                {step.icon}
              </div>
            </div>

            <div className="bg-[#3C3B92] text-white  font-semibold px-3 py-1 rounded-md text-sm">
              {step.id}
            </div>
