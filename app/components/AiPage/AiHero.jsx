...
const HeroBanner = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br to-[#3C3B92] from-[#5B86E5] lg:h-[90vh] md:h-[85vh] h-[80vh] max-h-[800px] w-full flex items-center justify-center px-6 md:px-16 lg:px-24">
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between space-y-10 md:space-y-0">
        ...
        <div className="flex flex-col max-w-xl text-left">
          ...
          <Link
            href="/our-services"
            className="w-fit px-8 py-3 rounded-full bg-white text-[#2563EB] text-lg font-semibold shadow-md hover:bg-gray-900 transition"
          >
            Get Started
          </Link>
        </div>
