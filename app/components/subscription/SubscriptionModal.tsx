...
// Array of subscription plans. I've updated the plans to match the new image.
...
export const SubscriptionDialog = ({
  ...
  const handlePlanSelect = (plan: planState) => {
    ...
    // The `View Plan` button's colors have also been updated to have a white background and blue text when its parent card is active.
  ...
  return (
    <>
      <div className="fixed inset-0 bg-white/10 backdrop-blur-md z-50 flex lg:items-center lg:justify-center md:justify-center md:items-center justify-center lg:mt-0 md:mt-0 mt-2 lg:ml-0 md:ml-0 ml-2">
        <div className="bg-white rounded-lg shadow-lg w-[80%] p-6 overflow-y-auto lg:max-h-[90vh] md:max-h-[90vh] max-h-[140vh] relative">
          <button
